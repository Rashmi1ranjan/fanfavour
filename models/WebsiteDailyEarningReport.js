...
const WebsiteDailyEarningReportSchema = new Schema({
    domain: {
        type: String,
        index: true
    },
...
WebsiteDailyEarningReportSchema.index({ domain: 1, payment_gateway: 1, target_date: 1 })
module.exports = mongoose.model('WebsiteDailyEarningReport', WebsiteDailyEarningReportSchema, 'websitedailyearningreport')
